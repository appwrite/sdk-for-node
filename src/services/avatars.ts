...
export class Avatars {
     ...
     */
    getBrowser(params: { code: Browser, width?: number | bigint, height?: number | bigint, quality?: number | bigint  }): Promise<ArrayBuffer>;
    /**
     * You can use this endpoint to show different browser icons to your users. The code argument receives the browser code as it appears in your user [GET /account/sessions](https://appwrite.io/docs/references/cloud/client-web/account#getSessions) endpoint. Use width, height and quality arguments to change the output settings.
     * 
     * When one dimension is specified and the other is 0, the image is scaled with preserved aspect ratio. If both dimensions are 0, the API provides an image at source quality. If dimensions are not specified, the default size of image returned is 100x100px.
     ...
     */
    getBrowser(code: Browser, width?: number | bigint, height?: number | bigint, quality?: number | bigint): Promise<ArrayBuffer>;
    getBrowser(
     ...
     * @returns {Promise<ArrayBuffer>}
     */
    getCreditCard(params: { code: CreditCard, width?: number | bigint, height?: number | bigint, quality?: number | bigint  }): Promise<ArrayBuffer>;
    /**
     * The credit card endpoint will return you the icon of the credit card provider you need. Use width, height and quality arguments to change the output settings.
     * 
     * When one dimension is specified and the other is 0, the image is scaled with preserved aspect ratio. If both dimensions are 0, the API provides an image at source quality. If dimensions are not specified, the default size of image returned is 100x100px.
     ...
     * @deprecated Use the object parameter style method for a better developer experience.
     */
    getCreditCard(code: CreditCard, width?: number | bigint, height?: number | bigint, quality?: number | bigint): Promise<ArrayBuffer>;
    getCreditCard(
     ...
     * @returns {Promise<ArrayBuffer>}
     */
    getFlag(params: { code: Flag, width?: number | bigint, height?: number | bigint, quality?: number | bigint  }): Promise<ArrayBuffer>;
    /**
     * You can use this endpoint to show different country flags icons to your users. The code argument receives the 2 letter country code. Use width, height and quality arguments to change the output settings. Country codes follow the [ISO 3166-1](https://en.wikipedia.org/wiki/ISO_3166-1) standard.
     * 
     * When one dimension is specified and the other is 0, the image is scaled with preserved aspect ratio. If both dimensions are 0, the API provides an image at source quality. If dimensions are not specified, the default size of image returned is 100x100px.
     ...
     * @deprecated Use the object parameter style method for a better developer experience.
     */
    getFlag(code: Flag, width?: number | bigint, height?: number | bigint, quality?: number | bigint): Promise<ArrayBuffer>;
    getFlag(
     ...
     * @returns {Promise<ArrayBuffer>}
     */
    getImage(params: { url: string, width?: number | bigint, height?: number | bigint  }): Promise<ArrayBuffer>;
    /**
     * Use this endpoint to fetch a remote image URL and crop it to any image size you want. This endpoint is very useful if you need to crop and display remote images in your app or in case you want to make sure a 3rd party image is properly served using a TLS protocol.
     * 
     * When one dimension is specified and the other is 0, the image is scaled with preserved aspect ratio. If both dimensions are 0, the API provides an image at source quality. If dimensions are not specified, the default size of image returned is 400x400px.
     ...
     * @deprecated Use the object parameter style method for a better developer experience.
     */
    getImage(url: string, width?: number | bigint, height?: number | bigint): Promise<ArrayBuffer>;
    getImage(
     ...
     * @returns {Promise<ArrayBuffer>}
     */
    getInitials(params?: { name?: string, width?: number | bigint, height?: number | bigint, background?: string  }): Promise<ArrayBuffer>;
    /**
     * Use this endpoint to show your user initials avatar icon on your website or app. By default, this route will try to print your logged-in user name or email initials. You can also overwrite the user name if you pass the 'name' parameter. If no name is given and no user is logged, an empty avatar will be returned.
     * 
     * You can use the color and background params to change the avatar colors. By default, a random theme will be selected. The random theme will persist for the user's initials when reloading the same theme will always return for the same initials.
     ...
     * @deprecated Use the object parameter style method for a better developer experience.
     */
    getInitials(name?: string, width?: number | bigint, height?: number | bigint, background?: string): Promise<ArrayBuffer>;
    getInitials(
     ...
     * @returns {Promise<ArrayBuffer>}
     */
    getQR(params: { text: string, size?: number | bigint, margin?: number | bigint, download?: boolean  }): Promise<ArrayBuffer>;
    /**
     * Converts a given plain text to a QR code image. You can use the query parameters to change the size and style of the resulting image.
     * 
     *
     ...
     * @deprecated Use the object parameter style method for a better developer experience.
     */
    getQR(text: string, size?: number | bigint, margin?: number | bigint, download?: boolean): Promise<ArrayBuffer>;
    getQR(
