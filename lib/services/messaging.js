...
class Messaging extends Service {
     ...
     * @returns {Promise}
     */
    async updateSMTPProvider(providerId, name, host, port, username, password, encryption, autoTLS, fromName, fromEmail, replyToName, replyToEmail, enabled) {
     ...
     * @returns {Promise}
     */
    async createTelesignProvider(providerId, name, from, username, password, enabled) {
     ...
     * @returns {Promise}
     */
    async updateTelesignProvider(providerId, name, enabled, username, password, from) {
     ...
     * @returns {Promise}
     */
    async createTopic(topicId, name) {
        const apiPath = '/messaging/topics';
        let payload = {};
