...
describe('Tokens', () => {
    ...
    test('test method list()', async () => {
        ...
        const response = await tokens.list('<BUCKET_ID>', '<FILE_ID>');
    ...
    test('test method get()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await tokens.get('<TOKEN_ID>');
    ...
    test('test method update()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await tokens.update('<TOKEN_ID>');
    ...
    test('test method delete()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await tokens.delete('<TOKEN_ID>');
