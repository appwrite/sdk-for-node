...
describe('Messaging', () => {
    ...
    test('test method updateEmail()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.updateEmail('<MESSAGE_ID>');
    ...
    test('test method createPush()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.createPush('<MESSAGE_ID>');
    ...
    test('test method updatePush()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.updatePush('<MESSAGE_ID>');
    ...
    test('test method createSms()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.createSms('<MESSAGE_ID>', '<CONTENT>');
    ...
    test('test method updateSms()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.updateSms('<MESSAGE_ID>');
    ...
    test('test method getMessage()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.getMessage('<MESSAGE_ID>');
    ...
    test('test method delete()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.delete('<MESSAGE_ID>');
    ...
    test('test method listTargets()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.listTargets('<MESSAGE_ID>');
    ...
    test('test method updateApnsProvider()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.updateApnsProvider('<PROVIDER_ID>');
    ...
    test('test method createAppwriteProvider()', async () => {
        const data = {
            '\\$id': '5e5ea5c16897e',
            '\\$createdAt': '2020-10-15T06:38:00.000+00:00',
            '\\$updatedAt': '2020-10-15T06:38:00.000+00:00',
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.createAppwriteProvider(
            '<PROVIDER_ID>',
            '<NAME>',
        );
    ...
    test('test method updateAppwriteProvider()', async () => {
        const data = {
            '\\$id': '5e5ea5c16897e',
            '\\$createdAt': '2020-10-15T06:38:00.000+00:00',
            '\\$updatedAt': '2020-10-15T06:38:00.000+00:00',
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response =
            await messaging.updateAppwriteProvider('<PROVIDER_ID>');
    ...
    test('test method updateFcmProvider()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.updateFcmProvider('<PROVIDER_ID>');
    ...
    test('test method updateMailgunProvider()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.updateMailgunProvider('<PROVIDER_ID>');
    ...
    test('test method updateMsg91Provider()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.updateMsg91Provider('<PROVIDER_ID>');
    ...
    test('test method updateResendProvider()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.updateResendProvider('<PROVIDER_ID>');
    ...
    test('test method updateSendgridProvider()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response =
            await messaging.updateSendgridProvider('<PROVIDER_ID>');
    ...
    test('test method updateSesProvider()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.updateSesProvider('<PROVIDER_ID>');
    ...
    test('test method updateSmtpProvider()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.updateSmtpProvider('<PROVIDER_ID>');
    ...
    test('test method updateTelesignProvider()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response =
            await messaging.updateTelesignProvider('<PROVIDER_ID>');
    ...
    test('test method updateTextmagicProvider()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response =
            await messaging.updateTextmagicProvider('<PROVIDER_ID>');
    ...
    test('test method updateTwilioProvider()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.updateTwilioProvider('<PROVIDER_ID>');
    ...
    test('test method updateVonageProvider()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.updateVonageProvider('<PROVIDER_ID>');
    ...
    test('test method getProvider()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.getProvider('<PROVIDER_ID>');
    ...
    test('test method deleteProvider()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.deleteProvider('<PROVIDER_ID>');
    ...
    test('test method createTopic()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.createTopic('<TOPIC_ID>', '<NAME>');
    ...
    test('test method getTopic()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.getTopic('<TOPIC_ID>');
    ...
    test('test method updateTopic()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.updateTopic('<TOPIC_ID>');
    ...
    test('test method deleteTopic()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.deleteTopic('<TOPIC_ID>');
    ...
    test('test method listSubscribers()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await messaging.listSubscribers('<TOPIC_ID>');
