...
describe('Project', () => {
    ...
    test('test method updateAuthMethod()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.updateAuthMethod('email-password', true);
    ...
    test('test method createEphemeralKey()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.createEphemeralKey([], 1);
    ...
    test('test method getKey()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.getKey('<KEY_ID>');
    ...
    test('test method updateKey()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.updateKey('<KEY_ID>', '<NAME>', []);
    ...
    test('test method deleteKey()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.deleteKey('<KEY_ID>');
    ...
    test('test method createMockPhone()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.createMockPhone('+12065550100', '<OTP>');
    ...
    test('test method getMockPhone()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.getMockPhone('+12065550100');
    ...
    test('test method updateMockPhone()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.updateMockPhone('+12065550100', '<OTP>');
    ...
    test('test method deleteMockPhone()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.deleteMockPhone('+12065550100');
    ...
    test('test method getPlatform()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.getPlatform('<PLATFORM_ID>');
    ...
    test('test method deletePlatform()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.deletePlatform('<PLATFORM_ID>');
    ...
    test('test method updateDenyAliasedEmailPolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.updateDenyAliasedEmailPolicy(true);
    ...
    test('test method updateDenyCorporateEmailPolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.updateDenyCorporateEmailPolicy(true);
    ...
    test('test method updateDenyDisposableEmailPolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.updateDenyDisposableEmailPolicy(true);
    ...
    test('test method updateDenyFreeEmailPolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.updateDenyFreeEmailPolicy(true);
    ...
    test('test method updatePasswordDictionaryPolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.updatePasswordDictionaryPolicy(true);
    ...
    test('test method updatePasswordHistoryPolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.updatePasswordHistoryPolicy(1);
    ...
    test('test method updateSessionAlertPolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.updateSessionAlertPolicy(true);
    ...
    test('test method updateSessionDurationPolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.updateSessionDurationPolicy(1);
    ...
    test('test method updateSessionInvalidationPolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.updateSessionInvalidationPolicy(true);
    ...
    test('test method updateSessionLimitPolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.updateSessionLimitPolicy(1);
    ...
    test('test method updateUserLimitPolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.updateUserLimitPolicy(1);
    ...
    test('test method getPolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.getPolicy('password-dictionary');
    ...
    test('test method updateProtocol()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.updateProtocol('rest', true);
    ...
    test('test method updateService()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.updateService('account', true);
    ...
    test('test method updateEmailTemplate()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.updateEmailTemplate('verification');
    ...
    test('test method getEmailTemplate()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.getEmailTemplate('verification');
    ...
    test('test method getVariable()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.getVariable('<VARIABLE_ID>');
    ...
    test('test method updateVariable()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.updateVariable('<VARIABLE_ID>');
    ...
    test('test method deleteVariable()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await project.deleteVariable('<VARIABLE_ID>');
