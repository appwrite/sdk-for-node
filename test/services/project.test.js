...
describe('Project', () => {
    ...
    test('test method updateCanonicalEmails()', async () => {
        const data = {
            '\$id': '5e5ea5c16897e',
        ...
        const response = await project.updateCanonicalEmails(
            true,
        );
    ...
    test('test method updateDisposableEmails()', async () => {
        const data = {
            '\$id': '5e5ea5c16897e',
            '\$createdAt': '2020-10-15T06:38:00.000+00:00',
            '\$updatedAt': '2020-10-15T06:38:00.000+00:00',
        ...
        const response = await project.updateDisposableEmails(
            true,
        );
    ...
    test('test method updateFreeEmails()', async () => {
        const data = {
            '\$id': '5e5ea5c16897e',
            '\$createdAt': '2020-10-15T06:38:00.000+00:00',
            '\$updatedAt': '2020-10-15T06:38:00.000+00:00',
        ...
        const response = await project.updateFreeEmails(
            true,
        );
