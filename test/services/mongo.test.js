...
const { Mongo } = require('../../dist/services/mongo');
...
describe('Mongo', () => {
    ...
    test('test method list()', async () => {
        ...
        const response = await mongo.list();
    ...
    test('test method create()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.create('<DATABASE_ID>', '<NAME>');
    ...
    test('test method listSpecifications()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.listSpecifications();
    ...
    test('test method get()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.get('<DATABASE_ID>');
    ...
    test('test method update()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.update('<DATABASE_ID>');
    ...
    test('test method delete()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.delete('<DATABASE_ID>');
    ...
    test('test method listBackups()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.listBackups('<DATABASE_ID>');
    ...
    test('test method createBackup()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.createBackup('<DATABASE_ID>');
    ...
    test('test method listBackupPolicies()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.listBackupPolicies('<DATABASE_ID>');
    ...
    test('test method createBackupPolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.createBackupPolicy(
            '<DATABASE_ID>',
            '<POLICY_ID>',
            '<NAME>',
            '',
    ...
    test('test method getBackupPolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.getBackupPolicy(
            '<DATABASE_ID>',
            '<POLICY_ID>',
        );
    ...
    test('test method updateBackupPolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.updateBackupPolicy(
            '<DATABASE_ID>',
            '<POLICY_ID>',
        );
    ...
    test('test method deleteBackupPolicy()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.deleteBackupPolicy(
            '<DATABASE_ID>',
            '<POLICY_ID>',
        );
    ...
    test('test method updateBackupStorage()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.updateBackupStorage(
            '<DATABASE_ID>',
            's3',
            '<BUCKET>',
            '<ACCESS_KEY>',
    ...
    test('test method getBackup()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.getBackup('<DATABASE_ID>', '<BACKUP_ID>');
    ...
    test('test method deleteBackup()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.deleteBackup(
            '<DATABASE_ID>',
            '<BACKUP_ID>',
        );
    ...
    test('test method listBranches()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.listBranches('<DATABASE_ID>');
    ...
    test('test method createBranch()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.createBranch('<DATABASE_ID>');
    ...
    test('test method deleteBranch()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.deleteBranch(
            '<DATABASE_ID>',
            '<BRANCH_ID>',
        );
    ...
    test('test method updateCredentials()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.updateCredentials('<DATABASE_ID>');
    ...
    test('test method createFailover()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.createFailover('<DATABASE_ID>');
    ...
    test('test method updateMaintenance()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.updateMaintenance(
            '<DATABASE_ID>',
            'sun',
            1,
        );
    ...
    test('test method createMigration()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.createMigration('<DATABASE_ID>', 'shared');
    ...
    test('test method listOperations()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.listOperations('<DATABASE_ID>');
    ...
    test('test method getPitr()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.getPitr('<DATABASE_ID>');
    ...
    test('test method getReplicas()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.getReplicas('<DATABASE_ID>');
    ...
    test('test method listRestorations()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.listRestorations('<DATABASE_ID>');
    ...
    test('test method createRestoration()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.createRestoration('<DATABASE_ID>');
    ...
    test('test method getRestoration()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.getRestoration(
            '<DATABASE_ID>',
            '<RESTORATION_ID>',
        );
    ...
    test('test method getStatus()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.getStatus('<DATABASE_ID>');
    ...
    test('test method createUpgrade()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mongo.createUpgrade(
            '<DATABASE_ID>',
            '<TARGET_VERSION>',
        );
