...
describe('Oauth2', () => {
    ...
    test('test method approve()', async () => {
        ...
        const response = await oauth2.approve('<GRANT_ID>');
    ...
    test('test method createGrant()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await oauth2.createGrant('<USER_CODE>');
    ...
    test('test method reject()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await oauth2.reject('<GRANT_ID>');
    ...
    test('test method revoke()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await oauth2.revoke('<TOKEN>');
    ...
    test('test method createToken()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await oauth2.createToken('<GRANT_TYPE>');
