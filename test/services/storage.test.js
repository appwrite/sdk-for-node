...
describe('Storage', () => {
    ...
    test('test method createBucket()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await storage.createBucket('<BUCKET_ID>', '<NAME>');
    ...
    test('test method getBucket()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await storage.getBucket('<BUCKET_ID>');
    ...
    test('test method updateBucket()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await storage.updateBucket('<BUCKET_ID>', '<NAME>');
    ...
    test('test method deleteBucket()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await storage.deleteBucket('<BUCKET_ID>');
    ...
    test('test method getFile()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await storage.getFile('<BUCKET_ID>', '<FILE_ID>');
    ...
    test('test method updateFile()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await storage.updateFile('<BUCKET_ID>', '<FILE_ID>');
