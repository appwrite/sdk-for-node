...
describe('Users', () => {
    ...
    test('test method create()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.create('<USER_ID>');
    ...
    test('test method deleteIdentity()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.deleteIdentity('<IDENTITY_ID>');
    ...
    test('test method updateImpersonator()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.updateImpersonator('<USER_ID>', true);
    ...
    test('test method createJWT()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.createJWT('<USER_ID>');
    ...
    test('test method updateLabels()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.updateLabels('<USER_ID>', []);
    ...
    test('test method listLogs()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.listLogs('<USER_ID>');
    ...
    test('test method listMemberships()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.listMemberships('<USER_ID>');
    ...
    test('test method updateMfa()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.updateMfa('<USER_ID>', true);
    ...
    test('test method listMfaFactors()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.listMfaFactors('<USER_ID>');
    ...
    test('test method getMfaRecoveryCodes()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.getMfaRecoveryCodes('<USER_ID>');
    ...
    test('test method updateMfaRecoveryCodes()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.updateMfaRecoveryCodes('<USER_ID>');
    ...
    test('test method createMfaRecoveryCodes()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.createMfaRecoveryCodes('<USER_ID>');
    ...
    test('test method updateName()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.updateName('<USER_ID>', '<NAME>');
    ...
    test('test method updatePassword()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.updatePassword('<USER_ID>', 'password');
    ...
    test('test method updatePhone()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.updatePhone('<USER_ID>', '+12065550100');
    ...
    test('test method getPrefs()', async () => {
        const data = {};
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.getPrefs('<USER_ID>');
    ...
    test('test method updatePrefs()', async () => {
        const data = {};
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.updatePrefs('<USER_ID>', {});
    ...
    test('test method listSessions()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.listSessions('<USER_ID>');
    ...
    test('test method createSession()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.createSession('<USER_ID>');
    ...
    test('test method deleteSessions()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.deleteSessions('<USER_ID>');
    ...
    test('test method deleteSession()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.deleteSession('<USER_ID>', '<SESSION_ID>');
    ...
    test('test method updateStatus()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.updateStatus('<USER_ID>', true);
    ...
    test('test method listTargets()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.listTargets('<USER_ID>');
    ...
    test('test method getTarget()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.getTarget('<USER_ID>', '<TARGET_ID>');
    ...
    test('test method updateTarget()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.updateTarget('<USER_ID>', '<TARGET_ID>');
    ...
    test('test method deleteTarget()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.deleteTarget('<USER_ID>', '<TARGET_ID>');
    ...
    test('test method createToken()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.createToken('<USER_ID>');
    ...
    test('test method updateEmailVerification()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.updateEmailVerification('<USER_ID>', true);
    ...
    test('test method updatePhoneVerification()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await users.updatePhoneVerification('<USER_ID>', true);
