...
describe('Apps', () => {
    ...
    test('test method create()', async () => {
        ...
        const response = await apps.create(
            '<APP_ID>',
            '<NAME>',
            [],
        );
    ...
    test('test method delete()', async () => {
        ...
        const response = await apps.delete(
            '<APP_ID>',
        );
    ...
    test('test method listInstallations()', async () => {
        ...
        const response = await apps.listInstallations(
            '<APP_ID>',
        );
    ...
    test('test method listKeys()', async () => {
        ...
        const response = await apps.listKeys(
            '<APP_ID>',
        );
    ...
    test('test method createKey()', async () => {
        ...
        const response = await apps.createKey(
            '<APP_ID>',
        );
    ...
    test('test method getKey()', async () => {
        ...
        const response = await apps.getKey(
            '<APP_ID>',
            '<KEY_ID>',
        );
    ...
    test('test method deleteKey()', async () => {
        ...
        const response = await apps.deleteKey(
            '<APP_ID>',
            '<KEY_ID>',
        );
    ...
    test('test method updateLabels()', async () => {
        ...
        const response = await apps.updateLabels(
            '<APP_ID>',
            [],
        );
    ...
    test('test method listSecrets()', async () => {
        ...
        const response = await apps.listSecrets(
            '<APP_ID>',
        );
    ...
    test('test method createSecret()', async () => {
        ...
        const response = await apps.createSecret(
            '<APP_ID>',
        );
    ...
    test('test method deleteSecret()', async () => {
        ...
        const response = await apps.deleteSecret(
            '<APP_ID>',
            '<SECRET_ID>',
        );
    ...
    test('test method deleteTokens()', async () => {
        ...
        const response = await apps.deleteTokens(
            '<APP_ID>',
        );
