...
describe('Backups', () => {
    ...
    test('test method getArchive()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await backups.getArchive('<ARCHIVE_ID>');
    ...
    test('test method deleteArchive()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await backups.deleteArchive('<ARCHIVE_ID>');
    ...
    test('test method getPolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await backups.getPolicy('<POLICY_ID>');
    ...
    test('test method updatePolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await backups.updatePolicy('<POLICY_ID>');
    ...
    test('test method deletePolicy()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await backups.deletePolicy('<POLICY_ID>');
