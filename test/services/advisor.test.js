...
describe('Advisor', () => {
    ...
    test('test method getReport()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await advisor.getReport('<REPORT_ID>');
    ...
    test('test method deleteReport()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await advisor.deleteReport('<REPORT_ID>');
    ...
    test('test method listInsights()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await advisor.listInsights('<REPORT_ID>');
