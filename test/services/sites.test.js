...
describe('Sites', () => {
    ...
    test('test method get()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await sites.get('<SITE_ID>');
    ...
    test('test method update()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await sites.update('<SITE_ID>', '<NAME>', 'analog');
    ...
    test('test method delete()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await sites.delete('<SITE_ID>');
    ...
    test('test method listLogs()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await sites.listLogs('<SITE_ID>');
    ...
    test('test method deleteLog()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await sites.deleteLog('<SITE_ID>', '<LOG_ID>');
    ...
    test('test method listVariables()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await sites.listVariables('<SITE_ID>');
    ...
    test('test method getVariable()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await sites.getVariable('<SITE_ID>', '<VARIABLE_ID>');
