...
describe('Mysql', () => {
    ...
    test('test method list()', async () => {
        ...
        const response = await mysql.list();
    ...
    test('test method create()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.create('<DATABASE_ID>', '<NAME>');
    ...
    test('test method listSpecifications()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.listSpecifications();
    ...
    test('test method get()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.get('<DATABASE_ID>');
    ...
    test('test method update()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.update('<DATABASE_ID>');
    ...
    test('test method delete()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.delete('<DATABASE_ID>');
    ...
    test('test method listBackups()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.listBackups('<DATABASE_ID>');
    ...
    test('test method createBackup()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.createBackup('<DATABASE_ID>');
    ...
    test('test method listBackupPolicies()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.listBackupPolicies('<DATABASE_ID>');
    ...
    test('test method createBackupPolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.createBackupPolicy(
            '<DATABASE_ID>',
            '<POLICY_ID>',
            '<NAME>',
            '',
    ...
    test('test method getBackupPolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.getBackupPolicy(
            '<DATABASE_ID>',
            '<POLICY_ID>',
        );
    ...
    test('test method updateBackupPolicy()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.updateBackupPolicy(
            '<DATABASE_ID>',
            '<POLICY_ID>',
        );
    ...
    test('test method deleteBackupPolicy()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.deleteBackupPolicy(
            '<DATABASE_ID>',
            '<POLICY_ID>',
        );
    ...
    test('test method updateBackupStorage()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.updateBackupStorage(
            '<DATABASE_ID>',
            's3',
            '<BUCKET>',
            '<ACCESS_KEY>',
    ...
    test('test method getBackup()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.getBackup('<DATABASE_ID>', '<BACKUP_ID>');
    ...
    test('test method deleteBackup()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.deleteBackup(
            '<DATABASE_ID>',
            '<BACKUP_ID>',
        );
    ...
    test('test method listBranches()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.listBranches('<DATABASE_ID>');
    ...
    test('test method createBranch()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.createBranch('<DATABASE_ID>');
    ...
    test('test method deleteBranch()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.deleteBranch(
            '<DATABASE_ID>',
            '<BRANCH_ID>',
        );
    ...
    test('test method updateCredentials()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.updateCredentials('<DATABASE_ID>');
    ...
    test('test method createExecution()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.createExecution('<DATABASE_ID>', '<SQL>');
    ...
    test('test method createFailover()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.createFailover('<DATABASE_ID>');
    ...
    test('test method updateMaintenance()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.updateMaintenance(
            '<DATABASE_ID>',
            'sun',
            1,
        );
    ...
    test('test method createMigration()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.createMigration('<DATABASE_ID>', 'shared');
    ...
    test('test method listOperations()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.listOperations('<DATABASE_ID>');
    ...
    test('test method getPitr()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.getPitr('<DATABASE_ID>');
    ...
    test('test method getPooler()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.getPooler('<DATABASE_ID>');
    ...
    test('test method updatePooler()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.updatePooler('<DATABASE_ID>');
    ...
    test('test method getReplicas()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.getReplicas('<DATABASE_ID>');
    ...
    test('test method listRestorations()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.listRestorations('<DATABASE_ID>');
    ...
    test('test method createRestoration()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.createRestoration('<DATABASE_ID>');
    ...
    test('test method getRestoration()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.getRestoration(
            '<DATABASE_ID>',
            '<RESTORATION_ID>',
        );
    ...
    test('test method getStatus()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.getStatus('<DATABASE_ID>');
    ...
    test('test method createUpgrade()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await mysql.createUpgrade(
            '<DATABASE_ID>',
            '<TARGET_VERSION>',
        );
