...
describe('Account', () => {
    ...
    test('test method getConsent()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await account.getConsent('<CONSENT_ID>');
    ...
    test('test method deleteConsent()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await account.deleteConsent('<CONSENT_ID>');
    ...
    test('test method listConsentTokens()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await account.listConsentTokens('<CONSENT_ID>');
    ...
    test('test method deleteIdentity()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await account.deleteIdentity('<IDENTITY_ID>');
    ...
    test('test method createMfaAuthenticator()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await account.createMfaAuthenticator('totp');
    ...
    test('test method updateMfaAuthenticator()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await account.updateMfaAuthenticator('totp', '<OTP>');
    ...
    test('test method deleteMfaAuthenticator()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await account.deleteMfaAuthenticator('totp');
    ...
    test('test method createMfaChallenge()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await account.createMfaChallenge('email');
    ...
    test('test method createSession()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await account.createSession('<USER_ID>', '<SECRET>');
    ...
    test('test method getSession()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await account.getSession('<SESSION_ID>');
    ...
    test('test method createOAuth2Token()', async () => {
        ...
        const response = await account.createOAuth2Token('amazon');
