...
describe('Avatars', () => {
    ...
    test('test method getBrowser()', async () => {
        ...
        const response = await avatars.getBrowser('aa');
    ...
    test('test method getCreditCard()', async () => {
        const data = new ArrayBuffer(0);
        mockedFetch.mockImplementation(() => new Response(data));
        const response = await avatars.getCreditCard('amex');
    ...
    test('test method getFavicon()', async () => {
        const data = new ArrayBuffer(0);
        mockedFetch.mockImplementation(() => new Response(data));
        const response = await avatars.getFavicon('https://example.com');
    ...
    test('test method getFlag()', async () => {
        const data = new ArrayBuffer(0);
        mockedFetch.mockImplementation(() => new Response(data));
        const response = await avatars.getFlag('af');
    ...
    test('test method getImage()', async () => {
        const data = new ArrayBuffer(0);
        mockedFetch.mockImplementation(() => new Response(data));
        const response = await avatars.getImage('https://example.com');
    ...
    test('test method getQR()', async () => {
        const data = new ArrayBuffer(0);
        mockedFetch.mockImplementation(() => new Response(data));
        const response = await avatars.getQR('<TEXT>');
    ...
    test('test method getScreenshot()', async () => {
        const data = new ArrayBuffer(0);
        mockedFetch.mockImplementation(() => new Response(data));
        const response = await avatars.getScreenshot('https://example.com');
