...
describe('Functions', () => {
    ...
    test('test method get()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await functions.get('<FUNCTION_ID>');
    ...
    test('test method update()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await functions.update('<FUNCTION_ID>', '<NAME>');
    ...
    test('test method delete()', async () => {
        const data = { message: '' };
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await functions.delete('<FUNCTION_ID>');
    ...
    test('test method listVariables()', async () => {
        ...
        mockedFetch.mockImplementation(() => Response.json(data));
        const response = await functions.listVariables('<FUNCTION_ID>');
